jQuery("#simulation")
  .on("click", ".s-5ea81192-f228-4992-9a2e-6ee8b74458f6 .click", function(event, data) {
  ...
  .on("pageload", ".s-5ea81192-f228-4992-9a2e-6ee8b74458f6 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
