jQuery("#simulation")
  .on("click", ".s-9eaf3b65-233c-4786-9741-f050a4784ed3 .click", function(event, data) {
  ...
  .on("pageload", ".s-9eaf3b65-233c-4786-9741-f050a4784ed3 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
