jQuery("#simulation")
  .on("click", ".s-50aedd31-ced5-4d5e-ac6e-b78f46c4d8d5 .click", function(event, data) {
  ...
  .on("pageload", ".s-50aedd31-ced5-4d5e-ac6e-b78f46c4d8d5 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
